...
db.exec(`CREATE UNIQUE INDEX IF NOT EXISTS idx_valet_ticket_active ON valet_records(ticket_uid) WHERE status = 'parked';`);
db.exec(`CREATE INDEX IF NOT EXISTS idx_valet_plate_active ON valet_records(plate_number, status);`);
